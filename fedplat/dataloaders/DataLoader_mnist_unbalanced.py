...
import numpy as np
class DataLoader_mnist_unbalanced(fp.DataLoader):
    ...
    def __init__(self,
        ...
        name = 'MNIST_pool_' + str(pool_size) + '_batchsize_' + str(batch_size) + '_types_' + str(types) + '_input_require_shape_' + str(input_require_shape)
        nickname = 'mnist unbalanced B' + str(batch_size) + ' N' + str(pool_size) + ' types' + str(types)
        ...
        if os.path.exists(file_path) and (recreate == False):
            ...
            train_data = torchvision.datasets.MNIST(root=fp.data_folder_path, train=True,
                                                    transform=transform, download=True)
            test_data = torchvision.datasets.MNIST(root=fp.data_folder_path, train=False,
                                                   transform=transform)

...
import numpy as np
import copy
class DataLoader_fashion(fp.DataLoader):
    ...
    def __init__(self,
        ...
        name = 'Fashion_pool_' + str(pool_size) + '_batchsize_' + str(batch_size) + '_sort_split_input_require_shape_' + str(input_require_shape)

...
import numpy as np
import copy
class DataLoader_cifar10(fp.DataLoader):
    ...
    def __init__(self,
        ...
        name = 'CIFAR10_pool_' + str(pool_size) + 'split_' + str(split_num) + 'pick' + str(pick_num) + '_batchsize_' + str(batch_size) + '_sort_split_input_require_shape_' + str(input_require_shape)
        nickname = 'cifar10 B' + str(batch_size) + ' S'+ str(split_num) + ' P' + str(pick_num) + ' N' + str(pool_size)
